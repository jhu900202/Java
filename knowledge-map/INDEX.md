...
- 실제 경로는 `src/<주 단원 디렉토리>/<패키지>/`입니다(예: 주 단원 04 → `src/04-io-network-threads/study_190318/`). 경로가 바뀌면 이 문장과 각 단원의 `evidence`만 갱신합니다.
...
| study_190313 | 2019-03-13 | study | 05 | 04 | 뉴스 100건 URLConnection+Jsoup 파싱 → Oracle NEWS 저장 미니 크롤러(DAO/VO 원형) | 한 파일 5클래스. DB 접속 정보 치환됨. UTF-8 | - |
...
| study_190318_mk2 | 2019-03-18 | study | 04 | - | 2단계: Runnable 내부 클래스 + 스레드로 양방향 1:1 채팅 | 사설 IP 치환됨 | - |
